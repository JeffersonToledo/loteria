<?php
  ...
  // $total = array($name01 => $num,$name02 => $num1,$name03 => $num2,$name04 => $num3, $name05 => $num4,$name06 => $num5,$name07 => $num6,$name08 => $num7,$name09 => $num8,$name10 => $num9);
